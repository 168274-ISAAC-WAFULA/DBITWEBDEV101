...
<head>
    ...
    <title>General Menu - All Items - Cafeteria</title>
    ...
    <style>
        ...
        * {
        ...
        .hero-section {
            background: linear-gradient(135deg, #2a9d8f 0%, #f4a261 50%, #e76f51 100%);
            color: white;
            padding: 6rem 0 4rem;
            margin-bottom: 3rem;
        }
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content text-center">
                ...
                <h1>📋 General Menu</h1>
                <p>Browse our complete selection of delicious meals available throughout the day</p>
            </div>
        </div>
    </section>
    ...
    <div class="container" style="padding-top: 2rem;">
        ...
        <div class="menu-nav">
            <div class="text-center mb-3">
                ...
                <a href="{{ route('menu.morning') }}" class="menu-nav-btn">
                    🌅 Morning
                </a>
                <a href="{{ route('menu.lunch') }}" class="menu-nav-btn">
                    🍽️ Lunch
                </a>
                <a href="{{ route('menu.afternoon-evening') }}" class="menu-nav-btn">
                    🌆 Afternoon/Evening
                </a>
                <a href="{{ route('menu.night') }}" class="menu-nav-btn">
                    🌙 Night
                </a>
                <a href="{{ route('menu.general') }}" class="menu-nav-btn active">
                    📋 General Menu
                </a>
        ...
        <div class="stats-section">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="stat-item">
                        <div class="stat-number">{{ $categories->sum(function($cat) { return $cat->menuItems->count(); }) }}</div>
                        <div class="stat-label">Total Items</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stat-item">
                        <div class="stat-number">KSh {{ number_format($categories->flatMap->menuItems->min('price')) }}</div>
        ...
        <div class="featured-section">
            <h2 class="featured-title">🌟 Popular Items from All Time Periods</h2>
            <div class="row">
                @foreach($featuredItems as $featured)
                <div class="col-md-4 mb-3">
                    <div class="featured-item text-center">
                        <div class="time-tag">{{ $featured['time'] }}</div>
            ...
            <div class="category-header">
                ...
                <div class="mt-2">
                    <span class="badge bg-light text-dark">
                        ...
                        {{ $category->menuItems->count() == 1 ? 'Item' : 'Items' }}
                    </span>
                </div>
            </div>
